...
public class AdminRegisterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        postAdapter = ArrayAdapter.createFromResource(getContext(), R.array.admin_list, android.R.layout.simple_spinner_item);
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    ...
                    reference = FirebaseDatabase.getInstance().getReference("User").child("Admin")
                            .child(user.getUid());
                    ...
                    reference.setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                pd.dismiss();
                                Intent i = new Intent(getContext(), AdminLandingActivvity.class);
